  ...
  return (
    <div className="col-span-2 flex justify-center">
      <Card className="p-0 hover:scale-[1.01] transition-transform duration-200 bg-white w-[80%] overflow-hidden">
        ...
        <div
          className={`p-5 px-6 border-b border-gray-300 flex items-center gap-4 ${
        ...
        <div
          className={`p-3 px-6 border-b border-gray-300 flex flex-col items-start space-y-2 ${
        ...
        >
          <span className="font-semibold text-medium text-gray-700 flex items-center gap-2">
            <Icon icon="mdi-golf" /> Booking Type:{" "}
            {bookingDetails.bookingType == 1 ? "9-Hole" : "18-Hole"}
          </span>
          <span className="font-semibold text-medium text-gray-700 flex items-center gap-2">
            <Icon icon="mdi-calendar" /> Tee Date:{" "}
        ...
        >
          <span className="text-gray-700 text-medium flex items-center gap-2">
            <Icon icon="mdi-golf" /> <strong>Golfers:</strong>{" "}
            {bookingDetails.numberOfGolfers || 1}
          </span>
          <span className="text-gray-700 mt-2 text-medium flex items-center gap-2">
            <Icon icon="mdi-person" /> <strong>Accompanying Persons:</strong>{" "}
            {bookingDetails.numberOfnonPlayers || 0}
          </span>
          <span className="text-gray-700 mt-2 text-medium flex items-center gap-2">
            <Icon icon="mdi-backpack" /> <strong>Caddies:</strong>{" "}
            {bookingDetails["Caddies"] || 0}
          </span>
          <span className="text-gray-700 mt-2 text-medium flex items-center gap-2">
            <Icon icon="mdi-car" /> <strong>Golf Carts:</strong>{" "}
            {bookingDetails["Golf Cart"] || 1}
          </span>
          <span className="text-gray-700 mt-2 text-medium flex items-center gap-2">
            <Icon icon="mdi-food" /> <strong>Food & Drinks:</strong>{" "}
        ...
        <div
          className={`p-3 px-6 border-gray-300 flex flex-col items-start space-y-2 ${
            isSectionDisabled(3) ? "opacity-50 pointer-events-none" : ""
          }`}
        >
          <span className="font-semibold text-medium text-gray-700 flex items-center gap-2">
            <Icon icon="mdi-currency-btc" /> <strong>Total Price:</strong>{" "}
